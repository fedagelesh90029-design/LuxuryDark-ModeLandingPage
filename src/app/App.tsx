...
// Готовые изделия — каталог продукции (цены для Сочи)
const catalogModels = [
  // ── Перголы / Беседки ──
  {
    name: "Пергола «Тень» с лазерной резкой",
    category: "Перголы",
    img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Премиум"],
    price: "от 390 000 ₽",
    description: "Дизайнерская пергола с ажурными панелями лазерной резки на стенах и крыше. Чёрный матовый каркас, уникальная игра теней. Размер от 3×3м.",
  },
  {
    name: "Беседка «Оазис» закрытого типа",
    category: "Перголы",
    img: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Эксклюзив"],
    price: "от 630 000 ₽",
    description: "Полноценная беседка с тремя стенами из лазерной резки, крышей и встроенной LED-подсветкой. Идеальна для вечернего отдыха у моря.",
  },
  {
    name: "Пергола «Минимал» с тентом",
    category: "Перголы",
    img: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c0?w=600&h=400&fit=crop&auto=format",
    tags: ["Современный", "Тент"],
    price: "от 280 000 ₽",
    description: "Лаконичная пергола с раздвижным тентом. Чистые линии, минимум деталей — максимум функциональности.",
  },
  // ── Столы из слэба ──
  {
    name: "Стол из слэба дуба «Река»",
    category: "Мебель",
    img: "https://images.unsplash.com/photo-1604074131665-7a4b13870ab3?w=600&h=400&fit=crop&auto=format",
    tags: ["Слэб", "Эпоксидка"],
    price: "от 45 000 ₽",
    description: "Стол-река из двух слэбов с заливкой прозрачной эпоксидной смолой. Ножки — лазерная резка с авторским узором. Каждый экземпляр уникален.",
  },
  {
    name: "Стол из слэба карагача",
    category: "Мебель",
    img: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=400&fit=crop&auto=format",
    tags: ["Слэб", "Живой край"],
    price: "от 38 000 ₽",
    description: "Массивный слэб карагача с живым краем на металлических X-ножках. Обработка маслом, естественная текстура дерева.",
  },
  {
    name: "Барная стойка из слэба",
    category: "Мебель",
    img: "https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=600&h=400&fit=crop&auto=format",
    tags: ["Слэб", "Бар"],
    price: "от 33 000 ₽",
    description: "Барная стойка из цельного слэба дуба на сварном металлическом основании. Идеально вписывается в беседку или зону у бассейна.",
  },
  // ── Заборы с лазерной резкой ──
  {
    name: "Забор «Флора» — лазерная резка",
    category: "Заборы",
    img: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Авторский"],
    price: "от 38 000 ₽/п.м.",
    description: "Растительный орнамент ручной разработки на стальных панелях. Антикоррозийное покрытие для морского климата Сочи.",
  },
  {
    name: "Забор «Геометрия» — лазерная резка",
    category: "Заборы",
    img: "https://images.unsplash.com/photo-1611072337226-1140ab367200?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Сложный"],
    price: "от 32 000 ₽/п.м.",
    description: "Геометрический орнамент лазерной резки. Эксклюзивный дизайн — каждый забор изготавливается по индивидуальному проекту.",
  },
  {
    name: "Забор «Ромб» — лазерная резка",
    category: "Заборы",
    img: "https://images.unsplash.com/photo-1644491629308-95a9084733ac?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Классика"],
    price: "от 22 000 ₽/п.м.",
    description: "Ромбовидный узор на чёрных матовых панелях. Строгий элегантный стиль для резиденций и вилл.",
  },
  // ── Заборы жалюзи ──
  {
    name: "Забор-жалюзи «Бриз»",
    category: "Заборы",
    img: "https://images.unsplash.com/photo-1717857539947-9db9a70d9fe5?w=600&h=400&fit=crop&auto=format",
    tags: ["Жалюзи", "Вентиляция"],
    price: "от 9 500 ₽/п.м.",
    description: "Горизонтальные ламели под углом — продуваемость без потери приватности. Идеален для влажного климата побережья.",
  },
  {
    name: "Забор-жалюзи «Премиум»",
    category: "Заборы",
    img: "https://images.unsplash.com/photo-1757439402342-976f4e0733ec?w=600&h=400&fit=crop&auto=format",
    tags: ["Жалюзи", "Усиленный"],
    price: "от 14 000 ₽/п.м.",
    description: "Широкие ламели с усиленным каркасом и антикоррозийной обработкой. Порошковая покраска в любой цвет RAL.",
  },
  // ── Декор ──
  {
    name: "Кашпо с лазерной резкой",
    category: "Декор",
    img: "https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=600&h=400&fit=crop&auto=format",
    tags: ["Лазерная резка", "Декор"],
    price: "от 6 000 ₽",
    description: "Декоративное кашпо из стали с ажурным узором. Порошковая покраска, размеры 40×40 и 60×60 см.",
  },
];
...
const portfolioFilters = ["Все", "Заборы", "Навесы", "Ворота", "Перголы", "Мебель", "Декор", "Фурнитура"];
